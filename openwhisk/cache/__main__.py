...
def main(args):
    ...
    if 'cache' not in globals():
        netMosaic = cv2.dnn.readNetFromTorch("./models/instance_norm/mosaic.t7")
        netCandy = cv2.dnn.readNetFromTorch("./models/instance_norm/candy.t7")
        nets = [netMosaic, netCandy]
        cache = nets
    else:
        nets = cache
